...
const sampleTasks: Task[] = [
  ...
  // Niranjan's Updated Tasks (Cleaned & Organized)
  // Infrastructure & Safety
  {
    id: 'niranjan-task-1',
    title: 'Warehouse branding - boards design',
    description: 'Design and implement warehouse branding boards and signage',
    status: 'todo',
    priority: 'medium',
    assigneeId: '2',
    dueDate: new Date('2025-08-25'),
    ...
    labels: [{ id: '4', name: 'Documentation', color: '#10b981' }, { id: '10', name: 'Marketing', color: '#ec4899' }],
    estimatedHours: 8,
    subtasks: [],
    comments: [],
    attachments: [],
  ...
  {
    id: 'niranjan-task-2',
    title: 'Fire safety, Smoke detectors',
    description: 'Implement and test fire safety systems and smoke detectors across warehouses',
    status: 'todo',
    priority: 'high',
    assigneeId: '2',
    dueDate: new Date('2025-08-22'),
  ...
  {
    id: 'niranjan-task-3',
    title: 'CCTV footage online (including Chennai CCTV)',
    description: 'Setup online CCTV monitoring system for all warehouses including Chennai',
    status: 'in-progress',
    priority: 'high',
    assigneeId: '2',
    dueDate: new Date('2025-08-20'),
  ...
  {
    id: 'niranjan-task-4',
    title: 'Labour and GST certificates in each warehouse',
    description: 'Ensure all warehouses have proper labour and GST compliance certificates',
    status: 'todo',
    priority: 'high',
    assigneeId: '2',
    dueDate: new Date('2025-08-18'),
  ...
  },
  {
    ...
    description: 'Setup and organize self storage unit management system',
    status: 'todo',
    priority: 'medium',
    assigneeId: '2',
    dueDate: new Date('2025-09-05'),
  ...
  // System & Dashboard Updates
  {
    ...
    description: 'Update and maintain accurate warehouse location data in dashboard',
    status: 'todo',
    priority: 'medium',
    assigneeId: '2',
    dueDate: new Date('2025-08-28'),
  ...
  {
    id: 'niranjan-task-7',
    title: 'Damage request form - 24 hours disable after retrieval',
    description: 'Implement 24-hour window for damage request form after retrieval completion',
    status: 'todo',
    priority: 'high',
    assigneeId: '2',
  ...
  {
    id: 'niranjan-task-8',
    title: 'Insurance value, Declared goods and Glass, Marble',
    description: 'Setup insurance valuation system for declared goods including glass and marble items',
    status: 'todo',
    priority: 'medium',
    assigneeId: '2',
    dueDate: new Date('2025-09-02'),
  ...
  {
    id: 'niranjan-task-9',
    title: 'Partial retrieval charges not reflecting correctly',
    description: 'Fix billing system to properly calculate and display partial retrieval charges',
    status: 'todo',
    priority: 'high',
    assigneeId: '2',
  ...
  // Operations & Services
  {
    ...
    description: 'Setup and manage packers and movers service for intercity orders',
    status: 'todo',
    priority: 'medium',
    assigneeId: '2',
    dueDate: new Date('2025-09-10'),
    createdAt: new Date('2025-08-13'),
    updatedAt: new Date('2025-08-13'),
    labels: [{ id: '11', name: 'Logistics', color: '#8b5cf6' }, { id: '2', name: 'Feature', color: '#3b82f6' }],
    estimatedHours: 14,
    subtasks: [],
    comments: [],
    attachments: [],
  },
  {
    ...
    description: 'Process pending instant payments and update inventory accordingly',
    status: 'in-progress',
    priority: 'high',
    assigneeId: '2',
    dueDate: new Date('2025-08-16'),
  ...
  {
    id: 'niranjan-task-12',
    title: 'Reports: Intercity and Shifting data handling',
    description: 'Generate and manage reports for intercity orders and shifting data',
    status: 'todo',
    priority: 'medium',
    assigneeId: '2',
    dueDate: new Date('2025-09-05'),
  ...
  },
  {
    ...
    description: 'Add terms and conditions display during retrieval booking process',
    status: 'todo',
    priority: 'medium',
    assigneeId: '2',
    dueDate: new Date('2025-08-30'),
    createdAt: new Date('2025-08-13'),
    updatedAt: new Date('2025-08-13'),
    labels: [{ id: '7', name: 'Frontend', color: '#06b6d4' }, { id: '14', name: 'Legal', color: '#64748b' }],
    estimatedHours: 4,
    subtasks: [],
    comments: [],
    attachments: [],
  ...
  {
    id: 'niranjan-task-14',
    title: 'Airtel leased line bills, address change',
    description: 'Manage Airtel leased line billing and process address changes',
    status: 'todo',
    priority: 'low',
    assigneeId: '2',
    dueDate: new Date('2025-09-15'),
  ...
  {
    id: 'niranjan-task-15',
    title: 'SG5 Wifi boosters',
    description: 'Install and configure WiFi boosters for SG5 warehouse',
    status: 'todo',
    priority: 'medium',
    assigneeId: '2',
  ...
  },
  {
    id: 'niranjan-task-16',
    title: 'SG5 UPS issue',
    description: 'Diagnose and resolve UPS power backup issues at SG5 warehouse',
    status: 'in-progress',
    priority: 'high',
    assigneeId: '2',
    ...
    createdAt: new Date('2025-08-13'),
    updatedAt: new Date('2025-08-13'),
    labels: [{ id: '1', name: 'Bug', color: '#ef4444' }, { id: '9', name: 'DevOps', color: '#f97316' }],
    estimatedHours: 6,
    subtasks: [],
    comments: [],
    attachments: [],
  },
  {
    ...
    description: 'Test transport application links and functionality',
    status: 'todo',
    priority: 'medium',
    assigneeId: '2',
    dueDate: new Date('2025-09-01'),
  ...
  // Analysis & Strategy
  {
    ...
    description: 'Conduct comprehensive analysis of UK warehouse operations and efficiency',
    status: 'todo',
    priority: 'medium',
    assigneeId: '2',
    dueDate: new Date('2025-09-20'),
    createdAt: new Date('2025-08-13'),
    updatedAt: new Date('2025-08-13'),
    labels: [{ id: '15', name: 'Analytics', color: '#a855f7' }, { id: '5', name: 'Research', color: '#f59e0b' }],
    estimatedHours: 16,
    subtasks: [],
    comments: [],
    attachments: [],
  ...
  // Harsha's Additional Infrastructure & Safety Tasks
  {
    id: 'harsha-task-11',
    title: 'Fix SG3 water leakages – Bangalore',
    description: 'Repair water leakage issues at SG3 warehouse facility in Bangalore',
    status: 'todo',
    priority: 'high',
    assigneeId: '4',
    dueDate: new Date('2025-08-20'),
    createdAt: new Date('2025-08-13'),
    updatedAt: new Date('2025-08-13'),
    labels: [{ id: '1', name: 'Bug', color: '#ef4444' }, { id: '11', name: 'Logistics', color: '#8b5cf6' }],
    estimatedHours: 8,
    subtasks: [],
    comments: [],
    attachments: [],
  },
  {
    ...
    description: 'Repair water leakage issues at HY-4 warehouse facility in Hyderabad',
    status: 'todo',
    priority: 'high',
    assigneeId: '4',
    dueDate: new Date('2025-08-22'),
  ...
  {
    id: 'harsha-task-13',
    title: 'Install smoke detectors and fire extinguishers – All cities',
    description: 'Install fire safety equipment across Mumbai, Delhi, and Coimbatore warehouses',
    status: 'todo',
    priority: 'high',
    assigneeId: '4',
    dueDate: new Date('2025-08-25'),
  ...
  },
  {
    ...
    description: 'Install and configure CCTV monitoring system at Mumbai warehouse',
    status: 'todo',
    priority: 'medium',
    assigneeId: '4',
    dueDate: new Date('2025-08-28'),
  ...
  },
  {
    ...
    description: 'Install mobile signal boosters at SG5 warehouse in Bangalore',
    status: 'todo',
    priority: 'medium',
    assigneeId: '4',
    dueDate: new Date('2025-09-05'),
  ...
  },
  {
    ...
    description: 'Install large signage boards at SG5 warehouse facility',
    status: 'todo',
    priority: 'medium',
    assigneeId: '4',
    dueDate: new Date('2025-08-30'),
  ...
  },
  {
    ...
    description: 'Create and setup digital room for monitoring and control at SG5',
    status: 'todo',
    priority: 'medium',
    assigneeId: '4',
    dueDate: new Date('2025-09-10'),
  ...
  },
  {
    ...
    description: 'Construct office cabin for administrative work at SG5 warehouse',
    status: 'todo',
    priority: 'medium',
    assigneeId: '4',
    dueDate: new Date('2025-09-15'),
  ...
  },
  {
    ...
    description: 'Construct mezzanine floor for additional storage space at SG5',
    status: 'todo',
    priority: 'low',
    assigneeId: '4',
  ...
  {
    id: 'harsha-task-20',
    title: 'Open bank account for employees – All cities',
    description: 'Setup employee bank accounts across all operational cities',
    status: 'todo',
    priority: 'high',
    assigneeId: '4',
    dueDate: new Date('2025-08-24'),
  ...
  },
  {
    ...
    description: 'Finalize GST registration process for Coimbatore warehouse operations',
    status: 'todo',
    priority: 'high',
    assigneeId: '4',
    dueDate: new Date('2025-08-18'),
  ...
  },
  {
    ...
    description: 'Setup cash salary accounting system for all Bangalore operations',
    status: 'todo',
    priority: 'medium',
    assigneeId: '4',
    dueDate: new Date('2025-09-02'),
  ...
  // Operations & Logistics Tasks
  {
    id: 'harsha-task-24',
    title: 'Sell vehicles – Multiple locations',
    description: 'Coordinate vehicle sales: TN12AP7683 Chennai, Bangalore vehicles',
    status: 'todo',
    priority: 'medium',
    assigneeId: '4',
    dueDate: new Date('2025-09-01'),
  ...
  },
  {
    ...
    description: 'Coordinate transfer of storage racks from Mumbai to Bangalore warehouse',
    status: 'todo',
    priority: 'medium',
    assigneeId: '4',
    dueDate: new Date('2025-08-30'),
  ...
  },
  {
    ...
    description: 'Coordinate transfer of storage racks from Mumbai to Pune warehouse',
    status: 'todo',
    priority: 'medium',
    assigneeId: '4',
    dueDate: new Date('2025-09-05'),
  ...
  },
  {
    ...
    description: 'Procure storage pallets for Coimbatore warehouse operations',
    status: 'todo',
    priority: 'medium',
    assigneeId: '4',
    dueDate: new Date('2025-08-28'),
  ...
  },
  {
    ...
    description: 'Procure office furniture for Bangalore warehouse administrative areas',
    status: 'todo',
    priority: 'low',
    assigneeId: '4',
    dueDate: new Date('2025-09-10'),
  ...
  },
  {
    ...
    description: 'Update warehouse management system with current layout information for all Bangalore facilities',
    status: 'todo',
    priority: 'medium',
    assigneeId: '4',
    dueDate: new Date('2025-09-08'),
    createdAt: new Date('2025-08-13'),
    updatedAt: new Date('2025-08-13'),
    labels: [{ id: '6', name: 'Backend', color: '#6366f1' }],
    estimatedHours: 8,
    subtasks: [],
    comments: [],
    attachments: [],
  },
  {
    ...
    description: 'Deploy QR code tracking system across all warehouse operations',
    status: 'todo',
    priority: 'medium',
    assigneeId: '4',
    dueDate: new Date('2025-09-15'),
    createdAt: new Date('2025-08-13'),
    updatedAt: new Date('2025-08-13'),
    labels: [{ id: '2', name: 'Feature', color: '#3b82f6' }, { id: '9', name: 'DevOps', color: '#f97316' }],
    estimatedHours: 20,
    subtasks: [],
    comments: [],
    attachments: [],
  ...
  {
    id: 'harsha-task-31',
    title: 'Add locations to Google Maps – Multiple cities',
    description: 'Add SG5 Bangalore and Mumbai warehouse locations to Google Maps',
    status: 'todo',
    priority: 'medium',
    assigneeId: '4',
    dueDate: new Date('2025-08-22'),
  ...
  {
    id: 'harsha-task-32',
    title: 'Default customers - action',
    description: 'Handle default customer accounts and implement recovery actions',
    status: 'todo',
    priority: 'high',
    assigneeId: '4',
    dueDate: new Date('2025-08-19'),
    createdAt: new Date('2025-08-13'),
    updatedAt: new Date('2025-08-13'),
    labels: [{ id: '13', name: 'CRM', color: '#22c55e' }],
    estimatedHours: 12,
    subtasks: [],
    comments: [],
    attachments: [],
  ...
  {
    id: 'harsha-task-33',
    title: 'Video testimonials from customers',
    description: 'Collect video testimonials from warehouse visit customers with SafeStorage branding',
    status: 'todo',
    priority: 'medium',
    assigneeId: '4',
