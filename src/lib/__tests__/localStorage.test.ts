...
describe('LocalStorageManager', () => {
  ...
  describe('Data Initialization', () => {
    it('should initialize default team members when empty', () => {
      ...
      // Check for default team members
      const unassigned = teamMembers.find(m => m.name === 'Unassigned')
    ...
    it('should not overwrite existing data during initialization', () => {
      const existingMembers = [
        { id: '2', name: 'Niranjan', role: 'QA Manager', email: 'niranjan@safestorage.in', userRole: 'admin' as const, avatar: undefined }
      ]
      const existingLabels = [
        { id: 'custom-1', name: 'Custom Label', color: '#123456' }
      ]
  ...
  describe('Clear All Data', () => {
    it('should clear all stored data', () => {
      ...
      LocalStorageManager.setTeamMembers([{ id: '2', name: 'Niranjan', role: 'QA', email: 'n@s.in', userRole: 'admin', avatar: undefined }])
